...
get_header(); ?>
	...
	<div class="row">
		<main id="content" class="col-sm-8 content-area image-attachment" role="main">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<nav role="navigation" id="image-navigation" class="image-navigation">
					<div class="nav-previous"><?php previous_image_link( false, __( '<span class="meta-nav">&larr;</span> Previous', 'nuthemes' ) ); ?></div>
					<div class="nav-next"><?php next_image_link( false, __( 'Next <span class="meta-nav">&rarr;</span>', 'nuthemes' ) ); ?></div>
